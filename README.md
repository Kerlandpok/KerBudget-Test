...
## 3.7.4 Test
- Correction du premier rendu au démarrage sur Android/Chrome.
- L’accueil Aujourd’hui est forcé au chargement et au retour dans l’application si la zone centrale est vide.
...
- Les mensualités déjà pointées ne sont pas ajoutées aux prévisions.
- Calcul limité au mois affiché pour préserver les performances.

## Correctif 3.7.7
- Numéro de version aligné dans index.html, app.js, manifest.json et Diagnostic.
- Cache PWA renouvelé.
