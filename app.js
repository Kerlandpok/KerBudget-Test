...
const D=window.INITIAL_DATA, KEY='budget2026.test.v2', BACKUP_KEY='budget2026.test.backups', APP_VERSION='3.3.7-test', MAX_BACKUPS=12;
...
function home(){
  ...
  return layout(`${monthbar()}
    ...
    <section class="today-grid">
      ...
      <button type="button" class="today-card savings" onclick="navigateTo('savings')"><span class="today-icon">◆</span><small>Épargne totale</small><strong>${euro(savingsTotal)}</strong><em>Virements pointés</em></button>
    </section>
