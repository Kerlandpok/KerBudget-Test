const CACHE='kerbudget-2-2-2-test-20260801';
const ASSETS=['./','./index.html','./styles.css?v=222','./app.js?v=222','./data.js?v=222','./excel-extra.js?v=222','./manifest.json','./icon.svg'];
